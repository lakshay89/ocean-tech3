            ...
            <div className="row">
                <div className="col-md-6">
                  ...
                  <div className='subtitle'>
                    ...
                    <p  className='para list1'  > Marketing Campaigns: To introduce products, services, or special deals to a wide group of people.</p>
                       <p  className='para list2'  >Customer Notifications: To let customers know about updates on their orders, reminders for appointments, or alerts about services.</p>
                       <p  className='para list3'  >Emergency Alerts: To quickly send urgent messages or warnings to a big group of people.</p>
                       <p  className='para list4'  > Event Reminders: To inform participants about upcoming events, any changes, or important details.</p>
